  ...
  return (
    <section class='auth-section'>
        ...
        <div class='auth-container-2'>
            {!isSignup && <img src={icon} alt='stack overflow' width="36px" className='login-logo'/>}
                ...
                </label>
                {
                    isSignup && (
                        <label htmlFor='check'>
                            ...
                            <p style={{fontsize:"13px"}}>Opt-in to receive ocasional,<br/>products updates,user research invitations,<br/>company announcements,and digests.</p>
                        </label>
                    )
                }
